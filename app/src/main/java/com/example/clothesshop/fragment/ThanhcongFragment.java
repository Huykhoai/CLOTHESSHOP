...
public class ThanhcongFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_thanhcong, container, false);
        Anhxa(view);
        getData();
        getDataUser();
        return view;
    ...
    private void Anhxa(View view) {
        listView = view.findViewById(R.id.listviewthanhcong_order);
        swipeRefreshLayout = view.findViewById(R.id.swipe_thanhcong);
