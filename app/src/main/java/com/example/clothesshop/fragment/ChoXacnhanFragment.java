...
public class ChoXacnhanFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_cho_xacnhan, container, false);
        Anhxa(view);
        getData();
        getDataUser();
        return view;
    ...
    private void Anhxa(View view) {
        listView = view.findViewById(R.id.listviewchoxacnhan_order);
        swipeRefreshLayout = view.findViewById(R.id.swipe_choxacnhan);
